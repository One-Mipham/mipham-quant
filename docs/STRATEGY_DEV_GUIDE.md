# Mipham Quant v3 Python Strategy Development Guide
...
Mipham Quant currently supports two Python authoring models:
...
This version is closer to how developers actually use Mipham Quant today:
