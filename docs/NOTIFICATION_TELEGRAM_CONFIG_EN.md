...
> Mipham Quant supports real-time strategy signal notifications via Telegram Bot.
...
3. Enter a display name for your bot (e.g., `Mipham Quant Signal Bot`)
4. Choose a unique username ending with `bot` (e.g., `mipham_quant_signal_bot`)
