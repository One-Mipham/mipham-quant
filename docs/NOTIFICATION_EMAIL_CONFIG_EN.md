...
> Mipham Quant supports strategy signal notifications via email, ideal for users who need detailed notification records.
...
- Mipham Quant backend service deployed and running

---

## Supported Email Providers

Mipham Quant supports any standard SMTP protocol email provider, including:
...
Yes, Mipham Quant automatically sends formatted HTML emails with a plain text fallback for maximum compatibility.
