<div align="center">
  <a href="https://github.com/brokermr810/Mipham Quant">
    <img src="screenshots/logo.jpg" alt="Mipham Quant Logo" width="220" height="220">
  </a>
  ...
  <p>
    ...
    <a href="https://ai.mipham.ai"><strong>在线演示</strong></a> &nbsp;·&nbsp;
    <a href="https://www.youtube.com/watch?v=tNAZ9uMiUUw"><strong>视频演示</strong></a> &nbsp;·&nbsp;
    <a href="https://www.mipham.ai"><strong>官网</strong></a> &nbsp;·&nbsp;
    <a href="https://t.me/miphamai"><strong>Telegram</strong></a> &nbsp;·&nbsp;
    <a href="https://discord.com/invite/tyx5B6TChr"><strong>Discord</strong></a> &nbsp;·&nbsp;
    <a href="https://youtube.com/@miphamai"><strong>YouTube</strong></a>
  </p>
  ...
  <p>
    ...
    <img src="https://img.shields.io/github/stars/brokermr810/Mipham Quant?style=flat-square&logo=github" alt="Stars">
  </p>
</div>

---

> Mipham Quant 是一个**可自托管、以本地优先为设计原则的量化交易与算法交易平台**，把 **AI 研究、Python 策略生成、回测验证和实盘执行** 放进同一套系统里。
...
```bash
git clone https://github.com/brokermr810/Mipham Quant.git && cd Mipham Quant && cp backend_api_python/env.example backend_api_python/.env && ./scripts/generate-secret-key.sh && docker-compose up -d --build
```
...
Mipham Quant 是一个**可自托管的 AI 交易平台**，也是一套**量化研究与策略运行工作台**，适合希望用一套系统完成以下工作的人：
...
如果你正在寻找的是**开源量化平台**、**AI 交易研究系统**、**可自托管回测系统**，或者**自然语言生成 Python 策略工作流**，Mipham Quant 就是按这个方向设计的。

## 为什么选择 Mipham Quant？AI 驱动的量化交易与回测平台
...
Mipham Quant 真正想提供的，不只是一个“量化工具”，而是：
...
Mipham Quant 不是简单地“在交易软件里加了个 LLM 聊天框”，而是把 AI 放进了真正的研究、策略和迭代流程里。
...
很多交易系统只能解决其中一两段链路，但 Mipham Quant 试图给你一整套“量化操作系统”：
...
从系统层面看，Mipham Quant 是一套可自托管应用栈：
...
```bash
git clone https://github.com/brokermr810/Mipham Quant.git
cd Mipham Quant
...
下面这种 Python 风格，就是 Mipham Quant 的典型策略开发方式：
...
### Mipham Quant 真的是可自托管的吗？

是的。默认部署方式就是你自己的 Docker Compose 栈，数据库、Redis、环境变量、API 凭证和业务数据都由你自己控制。

### Mipham Quant 只适合做加密货币吗？

不是。加密货币是核心场景之一，但平台也支持 IBKR 的美股链路、MT5 的外汇链路，以及 Polymarket 的研究型分析工作流。

### 我可以直接写 Python 策略吗？

可以。Mipham Quant 同时支持基于数据表的 `IndicatorStrategy` 和事件驱动的 `ScriptStrategy`。你也可以先让 AI 生成初稿，再自己继续修改。

### 它到底是研究工具还是实盘交易平台？

两者都是。Mipham Quant 想打通的是 AI 研究、图表、策略开发、回测、快速交易和实盘运营，而不是只做其中某一段。
...
| 仓库 | 作用 |
|------|------|
| [Mipham Quant](https://github.com/brokermr810/Mipham Quant) | 主仓库：后端、部署栈、文档、预构建前端交付 |
| [Mipham Quant Frontend](https://github.com/brokermr810/Mipham Quant-Vue) | Vue 前端源码仓库，适合 UI 开发与定制 |
...
| 交易所 | 注册链接 |
|--------|----------|
| Binance | [注册开户](https://www.bsmkweb.cc/register?ref=MIPHAMQUANT) |
| Bitget | [注册开户](https://partner.hdmune.cn/bg/7r4xz8kd) |
| Bybit | [注册开户](https://partner.bybit.com/b/DINGER) |
| OKX | [注册开户](https://www.xqmnobxky.com/join/MIPHAMQUANT) |
...
- 前端源码单独公开在 [Mipham Quant Frontend](https://github.com/brokermr810/Mipham Quant-Vue)，并适用 **Mipham Quant Frontend Source-Available License v1.0**。
...
- Website: [mipham.ai](https://mipham.ai)
- Telegram: [t.me/worldinbroker](https://t.me/worldinbroker)
- Email: [support@mipham.ai](mailto:support@mipham.ai)

## 法律声明与合规提示

- Mipham Quant 仅可用于合法的研究、教育、系统开发，以及符合法律法规要求的交易或运营场景。
- 任何个人或组织不得将本软件、其衍生版本或相关服务用于任何违法、欺诈、滥用、误导、市场操纵、违反制裁、洗钱或其他被禁止的用途。
- 任何基于 Mipham Quant 的商业使用、部署、运营、转售或服务化提供，都必须遵守所在国家或地区的适用法律法规，以及必要的许可、制裁、税务、数据保护、消费者保护、金融监管、市场规则和交易所规则。
- 用户应自行判断其使用行为是否合法，并自行承担审批、备案、披露、牌照或专业法律/税务/合规意见等责任。
- Mipham Quant 及其版权方、贡献者、许可方、维护者和相关开源参与方，不提供任何法律、税务、投资、合规或监管意见。
- 在适用法律允许的最大范围内，Mipham Quant 及相关权利方和贡献者，对任何因使用或误用本软件导致的违法使用、监管违规、交易损失、服务中断、执法措施或其他后果，不承担责任。

## 从这里开始

- **想先看产品效果？** 先打开[在线演示](https://ai.mipham.ai)或观看[视频演示](https://www.youtube.com/watch?v=tNAZ9uMiUUw)。
...
- **想做商业授权或定制化？** 直接通过 [mipham.ai](https://mipham.ai) 联系项目方。

## 社区与支持

<p>
  <a href="https://t.me/miphamai"><img src="https://img.shields.io/badge/Telegram-群组-26A5E4?style=for-the-badge&logo=telegram" alt="Telegram"></a>
  ...
  <a href="https://youtube.com/@miphamai"><img src="https://img.shields.io/badge/YouTube-频道-FF0000?style=for-the-badge&logo=youtube" alt="YouTube"></a>
</p>

- [贡献指南](../CONTRIBUTING.md)
- [问题反馈 / 功能建议](https://github.com/brokermr810/Mipham Quant/issues)
- Email: [support@mipham.ai](mailto:support@mipham.ai)
...
[![Star History Chart](https://api.star-history.com/svg?repos=brokermr810/Mipham Quant&type=Date)](https://star-history.com/#brokermr810/Mipham Quant&Date)

## 致谢

Mipham Quant 建立在优秀的开源生态之上，特别感谢以下项目：
...
<p align="center"><sub>如果 Mipham Quant 对你有帮助，欢迎点一个 GitHub Star。</sub></p>
