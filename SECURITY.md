...
Mipham Quant is a **local-first, self-hosted quantitative trading system**.
...
Mipham Quant is under active development.
...
or commit when running Mipham Quant in production environments.

---

## 🧠 Security Model & Scope

Mipham Quant is designed to run **entirely under the user’s control**.

### In Scope
We consider the following areas in scope for security review:

- Source code vulnerabilities in this repository
- Authentication and authorization logic within Mipham Quant
...
- Modified or unofficial builds of Mipham Quant

---

## 📣 Reporting a Vulnerability

If you believe you have found a security vulnerability in Mipham Quant,
...
Mipham Quant is provided **as-is**, without warranty.
...
Thank you for helping keep Mipham Quant safe.
