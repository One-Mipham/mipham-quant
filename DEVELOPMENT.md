# Mipham Quant — Development Guide
...
```bash
# 1. Clone
git clone https://github.com/<your-org>/mipham-quant.git
cd mipham-quant
...
```bash
# Linux/macOS — helper script (requires MIPHAM_QUANT_VUE_SRC)
export MIPHAM_QUANT_VUE_SRC=/path/to/private-vue-repo
