...
def _td_request(url: str, params: dict, timeout: int = 20) -> dict | None:
...
class ForexDataSource(BaseDataSource):
    ...
    def get_ticker(self, symbol: str) -> dict[str, Any]:
        ...
        for fetcher in (
            ...
            try:
                ...
                logger.debug(
                    "Forex ticker fetcher %s failed for %s: %s",
                    fetcher.__name__,
                    symbol,
                    e,
                )
    ...
    def _get_ticker_yfinance(self, symbol: str) -> dict[str, Any] | None:
    ...
    def get_kline(
        ...
        for fetcher in (
            ...
            try:
                ...
                logger.debug(
                    "Forex kline fetcher %s failed for %s: %s",
                    fetcher.__name__,
                    symbol,
                    e,
                )
