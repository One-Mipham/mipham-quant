...
def desktop_broker_cloud_reject_message() -> str:
    return (
        ...
        "请在个人电脑或私有服务器上本地部署 Mipham Quant，并安装 Interactive Brokers TWS/Gateway 或 MetaTrader 5。"
        " | This server has disabled IBKR/MT5 (requires local TWS/Gateway or MT5). "
        "Deploy Mipham Quant on your own machine and install IBKR or MetaTrader 5."
    )
