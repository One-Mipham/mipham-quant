    ...
    with _pool_lock:
        ...
        try:
            _connection_pool = pool.ThreadedConnectionPool(
                ...
                user=params.get("user", "mipham"),
                password=params.get("password", ""),
                dbname=params.get("dbname", "mipham_quant"),
                connect_timeout=10,
    ...
    def execute(self, query: str, args: Any = None):
        ...
        if is_insert and not has_returning:
            ...
            try:
                ...
                msg = str(e).lower()
                is_missing_id = 'column "id" does not exist' in msg or (
                    "undefinedcolumn" in e.__class__.__name__.lower() and '"id"' in msg
                )
