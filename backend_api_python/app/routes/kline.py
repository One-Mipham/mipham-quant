...
def get_kline():
    ...
    try:
        ...
        logger.error(f"Failed to fetch K-lines: {e!s}")
        logger.error(traceback.format_exc())
        return jsonify({"code": 0, "msg": f"Failed to fetch kline data: {e!s}", "data": None}), 500
...
def get_price():
    ...
    try:
        ...
        return jsonify({"code": 0, "msg": f"Failed to fetch price: {e!s}", "data": None}), 500
