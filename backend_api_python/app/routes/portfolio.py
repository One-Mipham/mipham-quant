...
def _get_single_price(market: str, symbol: str, force_refresh: bool = False) -> dict:
    ...
    try:
        ...
        logger.error(f"Failed to fetch price {market}:{symbol} - {e!s}")
        return {
            "market": market,
            "symbol": symbol,
            "price": 0,
...
def add_position():
    ...
    try:
        ...
        logger.error(f"add_position failed: {e!s}")
        logger.error(traceback.format_exc())
...
def update_position(position_id):
    ...
    try:
        ...
        logger.error(f"update_position failed: {e!s}")
        logger.error(traceback.format_exc())
        return jsonify({"code": 0, "msg": str(e), "data": None}), 500
...
def delete_position(position_id):
    ...
    try:
        ...
        logger.error(f"delete_position failed: {e!s}")
        logger.error(traceback.format_exc())
        return jsonify({"code": 0, "msg": str(e), "data": None}), 500
...
def get_portfolio_summary():
    ...
    try:
        ...
        logger.error(f"get_portfolio_summary failed: {e!s}")
        logger.error(traceback.format_exc())
        return jsonify({"code": 0, "msg": str(e), "data": None}), 500
...
def get_monitors():
    ...
    try:
        ...
        logger.error(f"get_monitors failed: {e!s}")
        logger.error(traceback.format_exc())
        return jsonify({"code": 0, "msg": str(e), "data": []}), 500
...
def add_monitor():
    ...
    try:
        ...
        notification_config_json = json.dumps(
            notification_config if isinstance(notification_config, dict) else {},
            ensure_ascii=False,
        )
        ...
        if is_active and monitor_id:
            try:
                from app.services.portfolio_monitor import (
                    run_single_monitor as _run_single_monitor,
                )
        ...
        logger.error(f"add_monitor failed: {e!s}")
        logger.error(traceback.format_exc())
        return jsonify({"code": 0, "msg": str(e), "data": None}), 500
...
def update_monitor(monitor_id):
    ...
    try:
        ...
        if "position_ids" in data:
            ...
            params.append(
                json.dumps(
                    position_ids if isinstance(position_ids, list) else [],
                    ensure_ascii=False,
                )
            )
        ...
        logger.error(f"update_monitor failed: {e!s}")
        logger.error(traceback.format_exc())
        return jsonify({"code": 0, "msg": str(e), "data": None}), 500
...
def delete_monitor(monitor_id):
    ...
    try:
        ...
        logger.error(f"delete_monitor failed: {e!s}")
        logger.error(traceback.format_exc())
        return jsonify({"code": 0, "msg": str(e), "data": None}), 500
...
def run_monitor_now(monitor_id):
    ...
    try:
        ...
        logger.error(f"run_monitor_now failed: {e!s}")
        logger.error(traceback.format_exc())
        return jsonify({"code": 0, "msg": str(e), "data": None}), 500
...
def get_alerts():
    ...
    try:
        ...
        logger.error(f"get_alerts failed: {e!s}")
        logger.error(traceback.format_exc())
        return jsonify({"code": 0, "msg": str(e), "data": []}), 500
    ...
    try:
        ...
        if alert_type not in valid_types:
            return jsonify(
                {
                    "code": 0,
                    "msg": f"Invalid alert_type. Must be one of: {valid_types}",
                    "data": None,
                }
            ), 400
        ...
        if threshold <= 0 and alert_type.startswith("price_"):
            return jsonify(
                {
                    "code": 0,
                    "msg": "Threshold must be positive for price alerts",
                    "data": None,
                }
            ), 400
        ...
        logger.error(f"add_alert failed: {e!s}")
        logger.error(traceback.format_exc())
        return jsonify({"code": 0, "msg": str(e), "data": None}), 500
...
def update_alert(alert_id):
    ...
    try:
        ...
        logger.error(f"update_alert failed: {e!s}")
        logger.error(traceback.format_exc())
        return jsonify({"code": 0, "msg": str(e), "data": None}), 500
...
def delete_alert(alert_id):
    ...
    try:
        ...
        logger.error(f"delete_alert failed: {e!s}")
        logger.error(traceback.format_exc())
        return jsonify({"code": 0, "msg": str(e), "data": None}), 500
...
def get_groups():
    ...
    try:
        ...
        groups = []
        for row in rows:
            groups.append({"name": row.get("group_name"), "count": row.get("count") or 0})
        ...
        return jsonify(
            {
                "code": 1,
                "msg": "success",
                "data": {"groups": groups, "ungrouped_count": ungrouped_count},
            }
        )
    except Exception as e:
        logger.error(f"get_groups failed: {e!s}")
        logger.error(traceback.format_exc())
        return jsonify({"code": 0, "msg": str(e), "data": None}), 500
...
def rename_group():
    ...
    try:
        ...
        logger.error(f"rename_group failed: {e!s}")
        logger.error(traceback.format_exc())
        return jsonify({"code": 0, "msg": str(e), "data": None}), 500
