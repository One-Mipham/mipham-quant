...
def _resolve_name_from_yfinance(symbol: str) -> str | None:
    """
    Best-effort company name via yfinance.
    """

    def _try_one(sym: str) -> str | None:
...
def _resolve_name_from_finnhub(symbol: str) -> str | None:
    """
...
def resolve_symbol_name(market: str, symbol: str) -> str | None:
    """
