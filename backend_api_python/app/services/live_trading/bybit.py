...
class BybitClient(BaseRestClient):
    ...
    def _resolve_position_idx(self, pos_side: str) -> int | None:
    ...
    def get_wallet_balance(self, *, account_type: str = "UNIFIED") -> dict[str, Any]:
        return self._signed_request(
            ...
            params={"accountType": str(account_type or "UNIFIED")},
        )
    ...
    def _normalize_qty(self, *, symbol: str, qty: float) -> tuple[Decimal, int | None]:
        q = self._to_dec(qty)
        if q <= 0:
    ...
    def _normalize_price(self, *, symbol: str, price: float) -> tuple[Decimal, int | None]:
