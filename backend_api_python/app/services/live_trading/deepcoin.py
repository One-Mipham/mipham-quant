...
class DeepcoinClient(BaseRestClient):
    ...
    def _build_uri_with_params(self, uri: str, params: dict[str, Any] | None, method: str) -> str:
        """
    ...
    def _public_request(self, method: str, uri: str, *, params: dict[str, Any] | None = None) -> dict[str, Any]:
        """
        ...
        try:
            ...
            raise LiveTradingError(f"Deepcoin request failed: {e!s}")
