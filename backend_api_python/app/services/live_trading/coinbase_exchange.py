...
class CoinbaseExchangeClient(BaseRestClient):
    ...
    def cancel_order(self, *, order_id: str = "", client_order_id: str = "") -> Any:
        if order_id:
            return self._signed_request("DELETE", f"/orders/{order_id!s}")
        if client_order_id:
            return self._signed_request("DELETE", f"/orders/client:{client_order_id!s}")
    ...
    def get_order(self, *, order_id: str = "", client_order_id: str = "") -> Any:
        if order_id:
            return self._signed_request("GET", f"/orders/{order_id!s}")
        if client_order_id:
            return self._signed_request("GET", f"/orders/client:{client_order_id!s}")
