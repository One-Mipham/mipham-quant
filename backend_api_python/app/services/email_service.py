...
class EmailService:
    ...
    def create_verification_code(self, email: str, code_type: str, ip_address: str = None) -> tuple[bool, str]:
        """
        ...
        try:
            with get_db_connection() as db:
                ...
                if lock_row and lock_row["cnt"] > 0:
                    ...
                    return (
                        False,
                        f"Too many failed attempts. Please try again in {self.code_lock_minutes} minutes",
                    )
    ...
    def send_verification_code(self, email: str, code_type: str, ip_address: str = None) -> tuple[bool, str]:
        """
        ...
        if code_type == "register":
            subject = "Mipham Quant - Verification Code for Registration"
            action_text = "complete your registration"
        elif code_type == "login":
            subject = "Mipham Quant - Quick Login Verification Code"
            action_text = "log in to your account"
        elif code_type == "reset_password":
            subject = "Mipham Quant - Password Reset Verification Code"
            action_text = "reset your password"
        elif code_type == "change_password":
            subject = "Mipham Quant - Verification Code for Password Change"
            action_text = "change your password"
        elif code_type == "change_email":
            subject = "Mipham Quant - Verification Code for Email Change"
            action_text = "change your email address"
        else:
            subject = "Mipham Quant - Verification Code"
            action_text = "complete the verification"

        html_body = f"""
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            <div style="text-align: center; margin-bottom: 30px;">
                <h1 style="color: #1890ff; margin: 0;">Mipham Quant</h1>
            ...
            <div style="text-align: center; margin-top: 30px; color: #999; font-size: 12px;">
                <p>&copy; One Mipham Corporation. All rights reserved.</p>
            </div>
        </div>
        """
